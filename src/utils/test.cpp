...
void TestMetaprogramming() {
	...
	struct C : public B {};
	static_assert(meta::IsBaseOf_v<C, B>);
	static_assert(!meta::IsBaseOf_v<C, A>);
	static_assert(!meta::IsBaseOf_v<int, double>);
	static_assert(!meta::IsBaseOf_v<B, C>);
	static_assert(!meta::IsBaseOf_v<int, C>);
